...
For a semantic change the pinned SingleStepTests corpus is the ground truth:
update the focused regression test first, then run the full vector gate
([validation](validation.md) has the commands).
